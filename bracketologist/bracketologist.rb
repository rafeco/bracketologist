...
class Picker
  def initialize
    ...
    # team in Pomeroy's system. You can generate the ratings.tsv file using the scraper.rb 
    # script
    @teams = {}
...
<body>
<h1>Bracketologist</h1>
<p>A toy for picking NCAA brackets by Rafe Colburn. If you use this to make your NCAA picks and 
win your pool, let me know on Twitter. I'm <a href="http://twitter.com/rafeco">@rafeco</a>.</p>
