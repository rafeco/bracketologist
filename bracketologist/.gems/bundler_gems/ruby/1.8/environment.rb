...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/tilt-1.3.3/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/tilt-1.3.3/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rack-1.4.1/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rack-1.4.1/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rack-protection-1.2.0/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/sinatra-1.3.2/lib")
